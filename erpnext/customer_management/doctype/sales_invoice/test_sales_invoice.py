...
import erpnext
from erpnext.accounts.doctype.account.test_account import (
    create_account,
...
class TestSalesInvoice(FrappeTestCase):
    ...
    def test_payment_entry_unlink_against_invoice(self):
        ...
        pe = get_payment_entry(
            "Sales Invoice", si.name, bank_account="_Test Bank - _TC"
        )
        pe.reference_no = "1"
    ...
    def test_payment_entry_unlink_against_standalone_credit_note(self):
        ...
        pe = get_payment_entry(
            "Sales Invoice", si1.name, bank_account="_Test Bank - _TC"
        )
        pe.append(
            "references",
            {
    ...
    def test_discount_amount_gl_entry(self):
        frappe.db.set_value(
            "Company", "_Test Company", "round_off_account", "Round Off - _TC"
        )
        si = frappe.copy_doc(test_records[3])
        si.discount_amount = 104.94
        si.append(
    ...
    def test_payment(self):
        ...
        self.assertEqual(
            frappe.db.get_value("Sales Invoice", w.name, "outstanding_amount"), 162.0
        )
        ...
        self.assertTrue(
            link_doctypes.index("GL Entry")
            > link_doctypes.index("Journal Entry Account")
        )

        jv.cancel()
        self.assertEqual(
            frappe.db.get_value("Sales Invoice", w.name, "outstanding_amount"), 562.0
        )
    ...
    def test_pos_gl_entry_with_perpetual_inventory(self):
        ...
        pos.append(
            "payments",
            {"mode_of_payment": "Cash", "account": "Cash - TCP1", "amount": 50},
        )
    ...
    def test_pos_returns_with_repayment(self):
        ...
        pos.append(
            "payments",
            {"mode_of_payment": "Cash", "account": "Cash - _TC", "amount": 500},
        )
        pos.insert()
        pos.submit()
    ...
    def test_pos_change_amount(self):
        ...
        pos.append(
            "payments",
            {"mode_of_payment": "Cash", "account": "Cash - TCP1", "amount": 60},
        )
    ...
    def test_auto_write_off_amount(self):
        ...
        pos.append(
            "payments",
            {"mode_of_payment": "Cash", "account": "Cash - TCP1", "amount": 40},
        )
    ...
    def validate_pos_gl_entry(
        self, si, pos, cash_amount, validate_without_change_gle=False
    ):
    ...
    def test_bin_details_of_packed_item(self):
        from erpnext.selling.doctype.product_bundle.test_product_bundle import (
            make_product_bundle,
        )
        ...
        if not frappe.db.exists("Item", "_Test Product Bundle Item New"):
            bundle_item = make_item(
                "_Test Product Bundle Item New", {"is_stock_item": 0}
            )
            bundle_item.append(
                "item_defaults",
                {
        ...
        make_stock_entry(
            item="_Packed Item New 1", target="_Test Warehouse - _TC", qty=120, rate=100
        )
    ...
    def test_serial_numbers_against_delivery_note(self):
        ...
        dn = create_delivery_note(
            item=se.get("items")[0].item_code, serial_no=serial_nos[0]
        )
        dn.submit()
    ...
    def test_return_sales_invoice(self):
        make_stock_entry(
            item_code="_Test Item", target="Stores - TCP1", qty=50, basic_rate=100
        )
        ...
        self.assertEqual(
            frappe.db.get_value("Sales Invoice", si1.name, "outstanding_amount"), -1000
        )
        self.assertEqual(
            frappe.db.get_value("Sales Invoice", si.name, "outstanding_amount"), 2500
        )

    def test_zero_qty_return_invoice_with_stock_effect(self):
        cr_note = create_sales_invoice(
            qty=-1, rate=300, is_return=1, do_not_submit=True
        )
    ...
    def test_gle_made_when_asset_is_returned(self):
        ...
        si = create_sales_invoice(
            item_code="Macbook Pro", asset=asset.name, qty=1, rate=90000
        )
        ...
        disposal_account = frappe.get_cached_value(
            "Company", "_Test Company", "disposal_account"
        )
    ...
    def test_incoming_rate_for_stand_alone_credit_note(self):
        ...
        debit_amount = frappe.db.get_value(
            "GL Entry",
            {"voucher_no": return_si.name, "account": "Stock In Hand - TCP1"},
            "debit",
        )
    ...
    def test_create_so_with_margin(self):
        ...
        si.save()
        self.assertEqual(
            si.get("items")[0].rate, flt((price_list_rate * 25) / 100 + price_list_rate)
        )
    ...
    def test_outstanding_amount_after_advance_jv_cancellation(self):
        ...
        self.assertEqual(
            ...
            flt(
                si.rounded_total - si.total_advance, si.precision("outstanding_amount")
            ),
        )
    ...
    def test_outstanding_amount_after_advance_payment_entry_cancellation(self):
        ...
        sales_order = make_sales_order(
            item_code="138-CMS Shoe", qty=1, price_list_rate=500
        )
        pe = frappe.get_doc(
            {
    ...
    def test_company_monthly_sales(self):
        ...
        si = create_sales_invoice()
        current_month_sales = frappe.get_cached_value(
            "Company", "_Test Company", "total_monthly_sales"
        )
        self.assertEqual(
            current_month_sales, existing_current_month_sales + si.base_grand_total
        )
    ...
    def test_sales_invoice_with_shipping_rule(self):
        from erpnext.accounts.doctype.shipping_rule.test_shipping_rule import (
            create_shipping_rule,
        )

        shipping_rule = create_shipping_rule(
            shipping_rule_type="Selling",
            shipping_rule_name="Shipping Rule - Sales Invoice Test",
        )
    ...
    def test_duplicate_due_date_in_terms(self):
        ...
        si.append(
            "payment_schedule",
            dict(due_date="2017-01-01", invoice_portion=50.00, payment_amount=50),
        )
        si.append(
            "payment_schedule",
            dict(due_date="2017-01-01", invoice_portion=50.00, payment_amount=50),
    ...
    def test_credit_note(self):
        ...
        si = create_sales_invoice(
            item_code="_Test Item", qty=(5 * -1), rate=500, is_return=1
        )
    ...
    def test_sales_invoice_with_cost_center(self):
        ...
        create_cost_center(
            cost_center_name="_Test Cost Center for BS Account", company="_Test Company"
        )

        si = create_sales_invoice_against_cost_center(
            cost_center=cost_center, debit_to="Debtors - _TC"
        )
    ...
    def test_deferred_revenue(self):
        ...
        si = create_sales_invoice(
            item=item.name, posting_date="2019-01-10", do_not_submit=True
        )
    ...
    def test_inter_company_transaction_without_default_warehouse(self):
        ...
        # setup
        old_negative_stock = frappe.db.get_single_value(
            "Stock Settings", "allow_negative_stock"
        )
        frappe.db.set_value("Stock Settings", None, "allow_negative_stock", 1)

        old_perpetual_inventory = erpnext.is_perpetual_inventory_enabled(
            "_Test Company 1"
        )
        ...
        self.assertEqual(
            target_doc.items[0].expense_account, "Stock Received But Not Billed - _TC1"
        )
        ...
        frappe.db.set_single_value(
            "Stock Settings", "allow_negative_stock", old_negative_stock
        )
    ...
    def test_internal_transfer_gl_precision_issues(self):
        ...
        if get_stock_balance(
            "_Test Internal Transfer Item", "Stores - TCP1", "2022-04-10"
        ):
            create_stock_reconciliation(
    ...
    def test_item_tax_net_range(self):
        ...
        sales_invoice = create_sales_invoice(
            item="T Shirt", rate=700, do_not_submit=True
        )
        self.assertEqual(
            sales_invoice.items[0].item_tax_template,
    ...
    def test_sales_invoice_with_discount_accounting_enabled(self):
        ...
        si = create_sales_invoice(
            discount_account=discount_account, discount_percentage=10, rate=90
        )
    ...
    @change_settings("Selling Settings", {"enable_discount_accounting": 1})
    def test_additional_discount_for_sales_invoice_with_discount_accounting_enabled(
        self,
    ):
    ...
    def test_asset_depreciation_on_sale_with_pro_rata(self):
        ...
        create_asset_data()
        asset = create_asset(
            item_code="Macbook Pro", calculate_depreciation=1, submit=1
        )
        ...
        create_sales_invoice(
            ...
            qty=1,
            rate=90000,
            posting_date=getdate("2021-09-30"),
        )
        asset.load_from_db()
        ...
        for i, schedule in enumerate(asset.schedules):
            ...
            self.assertEqual(
                expected_values[i][2], schedule.accumulated_depreciation_amount
            )
    ...
    def test_asset_depreciation_on_sale_without_pro_rata(self):
        ...
        create_sales_invoice(
            ...
            qty=1,
            rate=90000,
            posting_date=getdate("2021-12-31"),
        )
        asset.load_from_db()
    ...
    def test_sales_invoice_against_supplier(self):
        ...
        frappe.db.set_value(
            "Accounts Settings", None, "enable_common_party_accounting", 1
        )

        # create a sales invoice
        si = create_sales_invoice(
            customer=customer, parent_cost_center="_Test Cost Center - _TC"
        )
        ...
        party_link.delete()
        frappe.db.set_value(
            "Accounts Settings", None, "enable_common_party_accounting", 0
        )
    ...
    def test_over_billing_case_against_delivery_note(self):
        ...
        frappe.db.set_value(
            "Accounts Settings", None, "over_billing_allowance", over_billing_allowance
        )
    ...
    def test_multi_currency_deferred_revenue_via_journal_entry(self):
        ...
        frappe.db.set_value(
            "Accounts Settings", None, "acc_frozen_upto", getdate("2019-01-31")
        )
    ...
    def test_sales_invoice_with_disabled_account(self):
        try:
            ...
            self.assertTrue(
                "Cannot create accounting entries against disabled accounts"
    ...
    def test_gain_loss_with_advance_entry(self):
        ...
        jv = make_journal_entry(
            "_Test Receivable USD - _TC", "_Test Bank - _TC", -7000, save=False
        )
    ...
    def test_batch_expiry_for_sales_invoice_return(self):
        ...
        si = create_sales_invoice(
            qty=1, item_code=item.name, update_stock=1, batch_no=batch_no
        )
    ...
    def test_taxes_merging_from_delivery_note(self):
        ...
        map_docs(
            ...
            target_doc=si,
            args=json.dumps(
                {"customer": dn1.customer, "merge_taxes": 1, "filtered_children": []}
            ),
        )
        si.save().submit()
...
def create_sales_invoice(**args):
    ...
    si.append(
        "items",
        {
            ...
            "price_list_rate": (
                args.price_list_rate if args.get("price_list_rate") is not None else 100
            ),
...
def create_internal_parties():
    ...
    frappe.db.set_value(
        "Company", "_Test Company", "unrealized_profit_loss_account", account
    )
...
def create_internal_supplier(
    supplier_name, represents_company, allowed_to_interact_with
):
